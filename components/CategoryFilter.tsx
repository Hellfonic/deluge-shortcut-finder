...
const CategoryFilter: React.FC<CategoryFilterProps> = ({ categories, activeCategory, onSelectCategory }) => {
  ...
  return (
    <div className="flex w-full flex-nowrap gap-2 overflow-x-auto px-4 scrollbar-hidden cursor-grab sm:flex-wrap sm:justify-center sm:overflow-visible sm:px-0">
